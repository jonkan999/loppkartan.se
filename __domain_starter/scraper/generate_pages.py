...
def join_images_and_events(events, images, consider_only_new, current_events):
    ...
    print(f"Number of events to generate: {len(joined_data)}")
    return joined_data
...
if __name__ == "__main__":
    ...
    events_w_images = join_images_and_events(events, images, consider_only_new = True, current_events = all_events) #if consider_only_new, only events that has not already been generated
